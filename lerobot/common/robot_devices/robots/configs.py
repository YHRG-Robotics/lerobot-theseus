...
import draccus
from lerobot.common.robot_devices.robots.theseus import (ArmConfig, S1ArmConfig)
...
@dataclass
class TheseusManipulatorRobotConfig(RobotConfig):
    leader_arms: dict[str, ArmConfig] = field(default_factory=lambda: {})
    follower_arms: dict[str, ArmConfig] = field(default_factory=lambda: {})
    cameras: dict[str, CameraConfig] = field(default_factory=lambda: {})
    ...
    cameras: dict[str, CameraConfig] = field(
        default_factory=lambda: {
            ...
            "middle": OpenCVCameraConfig(
                camera_index=2, fps=30, width=640, height=480, rotation=None
            ),
